...
import static com.company.Order.readOrderedProductsFromFile;
                ...
                try {
                    ...
                    while (scanner.hasNextLine()) {
                        ...
                        if (line.contains( "Taken" ) || line.contains( "Cooking" )) {
                            Table table1 = new Table( 1, readOrderedProductsFromFile( "1.txt" ) );
...
//                (orders.contains( order.orderStatus==OrderStatus.TAKEN ) ){
                ...
                try {
                    ...
                    while (scanner.hasNextLine()) {
                        ...
                        lineNum++;
                        if (line.contains( "Taken" ) || line.contains( "Cooking" )) {
                            Table table1 = new Table( 1, readOrderedProductsFromFile( "2.txt" ) );
                            System.out.println( line );
                        }
            ...
            if (selection == 2) {
                ...
                String search = String.valueOf( OrderStatus.TAKEN );
                String replace = String.valueOf( OrderStatus.COOKING );
            ...
            if (selection == 3) {
                File order = new File( "1.txt" );
                File order1 = new File( "2.txt" );
                String search = String.valueOf( OrderStatus.COOKING );
                String replace = String.valueOf( OrderStatus.PREPARED );
