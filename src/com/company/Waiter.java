...
//                orders.add( order1 );
              ...
              Table table5=new Table( 5, orders );
                ...
                switch (tableNumber){
                    case 1:if (table1.getNumber()==tableNumber&&orders.isEmpty()){
//                Order order2=new Order("torta",3.5 );
                    ...
                    else System.out.println("This table is not free!"+" "+ orders);break;

                case 2:if (table2.getNumber()==tableNumber&&orders.isEmpty()){
//                Order order2=new Order("torta",3.5 );
                    String fileName=String.valueOf(tableNumber)+".txt";
                    order1.MilenaMakeOrder( fileName, true );}
                // order1.MilenaMakeOrder("order.txt",true);}
                else System.out.println("This table is not free!"+" "+ orders);break;
                    case 3:if (table3.getNumber()==tableNumber&&orders.isEmpty()){
//                Order order2=new Order("torta",3.5 );
                        String fileName=String.valueOf(tableNumber)+".txt";
                        order1.MilenaMakeOrder( fileName, true );}
                    // order1.MilenaMakeOrder("order.txt",true);}
                    else System.out.println("This table is not free!"+" "+ orders);break;
                    case 4:if (table4.getNumber()==tableNumber&&orders.isEmpty()){
//                Order order2=new Order("torta",3.5 );
                        String fileName=String.valueOf(tableNumber)+".txt";
                        order1.MilenaMakeOrder( fileName, true );}
                    // order1.MilenaMakeOrder("order.txt",true);}
                    else System.out.println("This table is not free!"+" "+ orders);break;
                    case 5:if (table5.getNumber()==tableNumber&&orders.isEmpty()){
//                Order order2=new Order("torta",3.5 );
                        String fileName=String.valueOf(tableNumber)+".txt";
                        order1.MilenaMakeOrder( fileName, true );}
                    // order1.MilenaMakeOrder("order.txt",true);}
